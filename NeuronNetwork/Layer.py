from mathfunction.MathFunction import *
...
class Layer:
    ...
    def __init__(self, number_of_neurons, previous_layer):
        ...
        if previous_layer:
            self.neurons_weight = 2 * np.random.random((number_of_neurons, previous_layer.number_of_neurons)) - 1 # uses with the previous layer
